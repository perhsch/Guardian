...
const AUTOMOD_PATHS: Record<string, string> = {
    antiraid: 'antiraid',
...
function isAutomodEnabled(doc: any, feature: string): boolean {
...
function getAutomodComponents(): ActionRowBuilder<ButtonBuilder>[] {
    return [
