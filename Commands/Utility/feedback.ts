import { SlashCommandBuilder, ChatInputCommandInteraction, Client, TextChannel, EmbedBuilder } from 'discord.js';
...
export default {
    ...
    async execute(interaction: ChatInputCommandInteraction, client: Client) {
        ...
        if (profanity.exists(feedback)) {
            return interaction.reply({
                content: '❌ Please keep your feedback respectful and constructive. Profanity is not allowed.',
                ephemeral: true
            });
        }
