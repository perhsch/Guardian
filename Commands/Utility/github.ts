...
export default {
    ...
    async execute(interaction: ChatInputCommandInteraction) {
        ...
        try {
                ...
                .addFields(
                    ...
                    },
                    {
                        ...
                        value: [
                            ...
                            lastActive
                                ? `Last active: <t:${Math.floor(lastActive.getTime() / 1000)}:R>`
                                : 'No recent activity',
                        ].join('\n'),
                        inline: true,
                    },
            ...
            if (data.company)
                embed.addFields({ name: '💼 Company', value: data.company, inline: false });
            if (data.email)
                embed.addFields({ name: '📧 Email', value: `||${data.email}||`, inline: false });
