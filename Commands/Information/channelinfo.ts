import { ChannelType, SlashCommandBuilder, ChatInputCommandInteraction, time, GuildChannel } from 'discord.js';
    ...
    async execute(interaction: ChatInputCommandInteraction) {
        ...
        const replyEmbed = EmbedGenerator.basicEmbed()
            ...
            .addFields(
                ...
                { name: 'Created at', value: `${time(Math.round((channel.createdTimestamp ?? Date.now()) / 1000), 'D')}`, inline: true },
