 ...
 * @param {Discord.TextChannel | Discord.ThreadChannel | Discord.VoiceChannel | Discord.StageChannel | Discord.DMChannel} channel
        ...
        for (const m of msgs) {
            ...
            const avatar =
                m && m.author && typeof m.author.displayAvatarURL === 'function'
                    ? m.author.displayAvatarURL({ extension: 'png', size: 128 })
                    : '';
